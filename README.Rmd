...
You can input parameters to compute power, for example here is a study with a hazard ratio of 1.2, an event probability of 0.8, and 200 participants:
...
This indicates that this study is 12.9% powered to detect a hazard ratio of 1.2 with a two-sided test with a significance level of 0.05.
