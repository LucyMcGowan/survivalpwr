...
You can input parameters to compute power, for example here is a study with a hazard ratio of 1.2, an event probability of 0.8, and 100 observations:
...
This indicates that this study is 41% powered to detect a hazard ratio of 1.2 with a two-sided test with a significance level of 0.05.
...
This indicates that you would need 52 observations with an event probability of 0.8 (or alternatively 41 events total) to be 80% powered to detect a hazard ratio of 1.5 with a two-sided test with a significance level of 0.05.
